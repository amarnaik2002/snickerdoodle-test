...
export default function LoyaltyBanner() {
  ...
  const beanBg = `url("data:image/svg+xml,%3Csvg width='64' height='64' xmlns='http://www.w3.org/2000/svg'%3E%3Cellipse cx='32' cy='32' rx='11' ry='17' transform='rotate(-20 32 32)' fill='none' stroke='rgba(212,64,10,.1)' stroke-width='1.5'/%3E%3Cpath d='M25 17 C30 25 30 39 25 47' fill='none' stroke='rgba(212,64,10,.07)' stroke-width='1' stroke-linecap='round'/%3E%3C/svg%3E")`
  ...
  return (
    <section ref={ref} style={{
      ...
      <div style={{
        ...
        width: '60%', height: '160%',
        background: 'radial-gradient(ellipse, rgba(212,64,10,.18) 0%, transparent 65%)',
        pointerEvents: 'none',
      }}/>
      ...
      <div className="loyalty-inner" style={{
        ...
        <h2 style={{
          ...
          Join the{' '}
          <span style={{ color: '#D4400A' }}>Snickerdoodle</span>{' '}Club
        </h2>
        ...
        <p style={{
          ...
          Birthday rewards, early menu access, and barista-only exclusives — all yours.
        </p>
        ...
        <div style={{ display: 'flex', gap: 10, maxWidth: 480, margin: '0 auto' }}>
          <input
            ...
            style={{
              ...
              border: `2px solid ${focused ? '#D4400A' : 'rgba(255,253,249,.14)'}`,
          ...
          <Btn
            ...
            style={{
              ...
              boxShadow: '0 4px 22px rgba(212,64,10,.45)',
              whiteSpace: 'nowrap',
            }}>
            Join Now
          </Btn>
